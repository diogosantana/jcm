...
pub struct GlobalOpts {
    ...
    #[arg(long, value_enum, default_value_t = ChainTarget::Root, global = true)]
    pub chain: ChainTarget,

    #[arg(long, default_value = "jcm-", global = true)]
    pub alias_prefix: String,

    #[arg(long, value_enum, default_value_t = ElevateMode::Auto, global = true)]
